    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "acquired",
                    models.DateField(
                        validators=[resume.models.date_validator_past_only],
                ...
                (
                    "expire",
                    models.DateField(
                        validators=[resume.models.date_validator_future_only],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "university",
                    models.CharField(max_length=140, verbose_name="Name of University"),
                ),
                ("college", models.CharField(max_length=140, verbose_name="College")),
                (
                    "degree",
                    models.CharField(max_length=140, verbose_name="Type of Degree"),
                ),
                ...
                (
                    "gpa",
                    models.DecimalField(
                        decimal_places=2, default=4.0, max_digits=4, verbose_name="GPA"
                    ),
                ),
                (
                    "banner",
                    models.FileField(
                        default="IMAGE URL", upload_to="", verbose_name="Banner Image"
                    ),
                ),
                (
                    "logo",
                    models.FileField(
                        default="IMAGE URL", upload_to="", verbose_name="Logo"
                    ),
                ),
                (
                    "mascot",
                    models.FileField(
                        default="IMAGE URL", upload_to="", verbose_name="Mascot Image"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current",
                    models.BooleanField(default=False, verbose_name="Current Role?"),
                ),
                (
                    "long_description",
                    models.TextField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="resume.Education"
            ),
        ),
    ]
